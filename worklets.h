...
///
template <typename FieldType, typename CountType, typename VertNumType >
...
public:
  ...
  VTKM_EXEC_EXPORT
  VertNumType operator()(vtkm::Id cellId, CountType& hasOutput) const
  {
    ...
    const VertNumType vertCount = this->vertTable.Get(cubeindex);
...
public:
  ...
  typedef PortalTypes< vtkm::UInt8 >::Portal UInt8PortalType;


  IdPortalType CellHasOutput;
  UInt8PortalType VertexCount;
...
{
public:
  typedef void ControlSignature(FieldIn<IdType> outputCellId,
                                FieldIn<IdType> inputCellId,
